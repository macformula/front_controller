...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC3     ------> ADC1_IN13
    */
    HAL_GPIO_DeInit(GPIOC, APPS1_Pin|APPS2_Pin|STEERING_ANGLE_SENSOR_Pin|BPPS_BUFFERED_Pin);
...
void HAL_CAN_MspInit(CAN_HandleTypeDef* hcan)
{
  ...
  /* USER CODE END CAN1_MspInit 0 */
    ...
    PA12     ------> CAN1_TX
    */
    GPIO_InitStruct.Pin = PT1_CAN_RX_Pin|PT1_CAN_TX_Pin;
  ...
  /* USER CODE END CAN2_MspInit 0 */
    ...
    PB6     ------> CAN2_TX
    */
    GPIO_InitStruct.Pin = PT2_CAN_RX_Pin|PT2_CAN_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_CAN_MspDeInit(CAN_HandleTypeDef* hcan)
{
  ...
  /* USER CODE END CAN1_MspDeInit 0 */
    ...
    PA12     ------> CAN1_TX
    */
    HAL_GPIO_DeInit(GPIOA, PT1_CAN_RX_Pin|PT1_CAN_TX_Pin);
  ...
  /* USER CODE END CAN2_MspDeInit 0 */
    ...
    PB6     ------> CAN2_TX
    */
    HAL_GPIO_DeInit(GPIOB, PT2_CAN_RX_Pin|PT2_CAN_TX_Pin);
  ...
  /* USER CODE END CAN3_MspDeInit 0 */
    ...
    PA15     ------> CAN3_TX
    */
    HAL_GPIO_DeInit(GPIOA, VEH_CAN_RX_Pin|VEH_CAN_TX_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI4_MspDeInit 0 */
    ...
    PE6     ------> SPI4_MOSI
    */
    HAL_GPIO_DeInit(GPIOE, IMU_SPI_CLK_Pin|IMU_SPI_MISO_Pin|IMU_SPI_MOSI_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, GPS_UART_TX_Pin|GPS_UART_RX_Pin);
